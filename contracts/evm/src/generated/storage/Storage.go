...
func NewStorage(
	...
	parsed, err := abi.JSON(strings.NewReader(StorageMetaData.ABI))
	if err != nil {
		return nil, err
	}
	codec, err := NewCodec()
...
func NewCodec() (StorageCodec, error) {
	parsed, err := abi.JSON(strings.NewReader(StorageMetaData.ABI))
	if err != nil {
		return nil, err
	}
...
func (c Storage) GetEffectiveReward(
	runtime cre.Runtime,
...
func (c Storage) RewardMultiplier(
	runtime cre.Runtime,
	blockNumber *big.Int,
) cre.Promise[*big.Int] {
...
func (c *Storage) DecodeOwnableInvalidOwnerError(data []byte) (*OwnableInvalidOwner, error) {
...
func (c *Storage) DecodeOwnableUnauthorizedAccountError(data []byte) (*OwnableUnauthorizedAccount, error) {
...
func (c *Storage) UnpackError(data []byte) (any, error) {
...
func (c *Storage) LogTriggerMultiplierUpdatedLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []MultiplierUpdated) (cre.Trigger[*evm.Log, *evm.Log], error) {
...
func (c *Storage) FilterLogsMultiplierUpdated(runtime cre.Runtime, options *bindings.FilterOptions) cre.Promise[*evm.FilterLogsReply] {
	if options == nil {
...
func (c *Storage) LogTriggerOwnershipTransferredLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []OwnershipTransferred) (cre.Trigger[*evm.Log, *evm.Log], error) {
...
func (c *Storage) FilterLogsOwnershipTransferred(runtime cre.Runtime, options *bindings.FilterOptions) cre.Promise[*evm.FilterLogsReply] {
	if options == nil {
		options = &bindings.FilterOptions{
			ToBlock: options.ToBlock,
		}
...
func (c *Storage) LogTriggerStakeAddedLog(chainSelector uint64, confidence evm.ConfidenceLevel, filters []StakeAdded) (cre.Trigger[*evm.Log, *evm.Log], error) {
...
func (c *Storage) FilterLogsStakeAdded(runtime cre.Runtime, options *bindings.FilterOptions) cre.Promise[*evm.FilterLogsReply] {
	if options == nil {
		options = &bindings.FilterOptions{
			ToBlock: options.ToBlock,
		}
